...
Builder.register("editor.settings", {
  ...
  designTokens: {
    colors: [
      ...
      { name: "Primary Opaque", value: "var(--primary-opaque, rgba(0, 98, 105, 0.1))" },
      { name: "Primary Dimmed", value: "var(--primary-dimmed, rgba(0, 98, 105, 0.15))" },
      { name: "Secondary", value: "var(--secondary, #00b0b9)" },
      { name: "Accent Orange", value: "var(--accent-orange, #f5875f)" },
      { name: "Primary Light Green", value: "var(--primary-lightgreen, #40c1ac)" },
    ...
    spacing: [
      ...
      { name: "Content Width Desktop", value: "var(--content-width-desktop, 1048px)" },
    ...
    fontFamily: [
      { name: "Primary Font", value: "var(--font-primary, 'Proxima Nova', sans-serif)" },
      { name: "Secondary Font", value: "var(--font-secondary, 'PT Serif', serif)" },
      { name: "Script Font", value: "var(--font-script, 'Dancing Script', sans-serif)" },
      { name: "Display Font", value: "var(--font-display, 'Canela Web', sans-serif)" },
    ],
    fontSize: [
    ...
    shadows: [
      { name: "Small", value: "var(--shadow-small, 0px 2px 4px rgba(0, 0, 0, 0.1))" },
      { name: "Medium", value: "var(--shadow-medium, 0px 4px 8px rgba(0, 0, 0, 0.1))" },
      { name: "Large", value: "var(--shadow-large, 0px 8px 16px rgba(0, 0, 0, 0.1))" },
    ],
    sizes: [
